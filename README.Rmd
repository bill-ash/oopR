...
A how to guide for implementing a S3 object oriented programming style in R.
...
Below are a list of helpful links for learning more about object oriented programming, 
the benefits, and how to do it in R. 
...
S3 allows you to overload functions by defining different methods for one generic. 
The arguments for each method must contain all the arguments to the generic. Both 
the generic and the method should contain a ... argument. 

Use `ls.str()` to get a better picture of what your list or environemnt object 
contain. 
...
The `print` generic function could have an unlimited number of methods using the
